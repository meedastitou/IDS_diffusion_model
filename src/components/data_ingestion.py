...
# from src.components.data_transfromation miport DataTransformation
@dataclass
class DataIngestionConfig:
    # train_data_path = os.path.join("artifacts/data_ingestion", "train.csv")
    # test_data_path = os.path.join("artifacts/data_ingestion", "test.csv")
    raw_data_path = os.path.join("artifacts/data_ingestion", "raw.gz")
...
class DataIngestion:
    ...
    def inititate_data_ingestion(self):
        ...
        try:
            ...
            data = pd.read_csv(os.path.join("notbook/data", "kddcup.data.gz"))
...
if __name__ =="__main__":
    obj = DataIngestion()
    raw_data_path = obj.inititate_data_ingestion()
